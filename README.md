...
| `DYNAMIC_CONTENT_ENABLED` | اختياري | `false` لتعطيل المدن والسيارات والخدمات والقوالب والمسارات وواجهات API وخرائط Sitemap الديناميكية؛ الافتراضي `true` |
...
### تعطيل المحتوى الديناميكي

يمكن تشغيل الموقع كمقالات وصفحات وتصنيفات فقط من دون حذف أي بيانات ديناميكية:

```env
DYNAMIC_CONTENT_ENABLED=false
```

عند التعطيل تُخفى أقسام المدن والسيارات والخدمات والقوالب من لوحة الإدارة، وتُغلق صفحاتها وواجهات API الخاصة بها، وتُزال خرائط Sitemap الديناميكية من فهرس Sitemap وتُرجع مساراتها المباشرة 404. تبقى المقالات والصفحات والتصنيفات وخرائط Sitemap الخاصة بها فعالة. القيمة الافتراضية هي `true` للمحافظة على توافق المواقع الحالية. بعد تغيير القيمة أعد بناء المشروع ثم أعد تشغيل التطبيق.
